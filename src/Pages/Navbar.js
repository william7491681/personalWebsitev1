...
export default function Navbar() {
    ...
    return (
        <nav className="fixed bg-[#34363b] flex flex-col md:flex-row md:justify-between w-full z-[1]">
            ...
            <ul className="h-[40px] flex justify-center md:justify-end mt-2 md:mt-0 items-center mb-1 md:mb-0">
                <a href="http://github.com/william7491681" target="_blank" rel="noopener noreferrer">
                    <BsGithub className="mr-7 transition duration-200 ease-out hover:scale-110"
                    color="white" size={30} />
                </a>
                <a href="http://linkedin.com/in/william-dines" target="_blank" rel="noopener noreferrer">
                    <BsLinkedin className="mr-7 transition duration-200 ease-out hover:scale-110"
                    color="white" size={30} />
                </a>
            </ul>
        </nav>
